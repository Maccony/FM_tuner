...
void setup(){
    ...
    // дергаем контакт RST на схеме Si4703 для инициализации микросхемы
    DDRB |= (1 << 1); // через регистр направления DDRB назначаем вывод PB1 выходным (OUTPUT), ставим бит №1 в HIGH
    PORTB |= (1 << 1); // через регистр данных порта PORTB устанавливаем на выводе PB1 зналение HIGH
