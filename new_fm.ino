...
void setup(){
    ...
    massiv_reg[26] |= (1<<XOSCEN); //запуск внутреннего генератора, включение бита XOSCEN (регистр 07h Test1).
    ...
    DDRB &= ~(1 << DDB4); // назначаем вывод PB4 входным INPUT, установим PB4 в LOW.
